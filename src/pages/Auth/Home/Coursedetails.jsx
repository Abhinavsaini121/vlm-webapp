...
import { 
  ArrowLeft, Star, Clock, Video, MessageCircle, 
  FileText, Smartphone, TrendingUp, Headphones, Infinity, 
  ListChecks, Award, ChevronRight, Heart, Play, Share2, CheckCircle2
} from "lucide-react";
    ...
    <div className="min-h-screen bg-[#0a0d14] text-white font-sans pb-24 lg:pb-10 selection:bg-[#3abef9]/30">
      ...
      <div className="relative h-[300px] sm:h-[400px] lg:h-[450px] w-full overflow-hidden">
        ...
        <div className="absolute bottom-6 left-4 lg:left-20 z-10">
           <div className="flex items-center gap-2 mb-2">
              <span className="bg-[#3abef9] text-black text-[9px] font-black px-2 py-0.5 rounded-full uppercase">Bestseller</span>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="flex items-center gap-4 sm:gap-8 bg-[#111721] p-4 rounded-2xl border border-white/5 overflow-x-auto no-scrollbar">
                <div className="flex items-center gap-2 shrink-0">
                  ...
                  <span className="text-[11px] font-bold uppercase text-gray-400">21 Lessons</span>
                </div>
                <div className="flex items-center gap-2 shrink-0">
                  <Clock size={18} className="text-[#3abef9]" />
                  <span className="text-[11px] font-bold uppercase text-gray-400">42 Hours</span>
                </div>
                <div className="flex items-center gap-2 shrink-0">
                  <TrendingUp size={18} className="text-[#3abef9]" />
                  <span className="text-[11px] font-bold uppercase text-gray-400">Beginner</span>
                </div>
            </div>
              ...
              {['About', 'Curriculum', 'Instructor', 'Reviews'].map((tab) => (
                <button 
                  ...
                  className={`px-6 py-4 text-xs font-black uppercase tracking-widest whitespace-nowrap transition-all relative ${
                    activeTab === tab.toLowerCase() ? 'text-[#3abef9]' : 'text-gray-500'
                  }`}
                >
                  {tab}
            ...
            <section className="animate-in fade-in slide-in-from-bottom-2 duration-500">
               ...
               <p className="text-sm sm:text-base text-gray-400 leading-relaxed">
                  Learn the fundamental principles of Thermodynamics with a focus on real-world engineering applications. This course covers everything from entropy to the second law of thermodynamics.
               </p>
            </section>
            ...
            <section>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {benefits.map((item, i) => (
                  <div key={i} className="flex items-center gap-3 bg-[#111721]/50 p-4 rounded-xl border border-white/5">
            ...
            <section className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 gap-4">
                 <ReviewCard name="Will Smith" img="https://i.pravatar.cc/150?u=will" />
                 <ReviewCard name="Martha Thompson" img="https://i.pravatar.cc/150?u=martha" />
              </div>
            </section>
          </div>
          ...
          <div className="hidden lg:block relative">
            <div className="sticky top-24 bg-[#111721] border-2 border-[#3abef9] rounded-[40px] p-8 shadow-2xl">
                ...
                <div className="space-y-4">
                    <p className="text-xs font-bold text-gray-400 uppercase">Instructor</p>
                    <div className="flex items-center gap-3 bg-black/20 p-3 rounded-xl">
                        <img src="https://i.pravatar.cc/150?u=3" className="w-10 h-10 rounded-full" alt="Robert" />
                        <div>
                            <h5 className="text-sm font-black">Robert Jr.</h5>
                            <p className="text-[10px] text-gray-500 uppercase">Physics Expert</p>
                        </div>
                    </div>
                </div>
            </div>
      ...
      <div className="lg:hidden fixed bottom-0 left-0 w-full bg-[#111721] border-t border-white/10 p-4 z-50 flex items-center justify-between gap-4 shadow-[0_-10px_20px_rgba(0,0,0,0.4)]">
          <div className="flex flex-col">
              <span className="text-gray-400 text-[10px] font-bold uppercase leading-none">Price</span>
...
const ReviewCard = ({ name, img }) => (
  <div className="bg-[#111721] p-5 rounded-2xl border border-white/5">
    ...
    <p className="text-xs text-gray-400 leading-relaxed italic">"Great course for anyone looking to master heat dynamics."</p>
  </div>
)
